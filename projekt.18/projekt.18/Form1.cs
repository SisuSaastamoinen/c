...
namespace projekt._18
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            string viite = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["IOD"].ToString(); 
            ...
            PostiLB.Text = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OPoistitoimipaikka"].ToString();
            PuhelinLB.Text = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OPuhelin"].ToString();

            yhetys = taytaVastuuHenkiloTaulukko.Select("OID=" + viite).CopyToDataTable();
            HenkilöCB.DataSource = yhteys;
            HenkilöCB.DisplayMamber = "VNimi";
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            OppilaitosCB.DsiplayMember = "ONimi";
        ...
        {
            oppilaitos.Columns.Add("OID", typeof(int));
            oppilaitos.Columns.Add("VNimi");
            oppilaitos.Columns.Add("VTitteli");
            oppilaitos.Columns.Add("VOsasto");
            oppilaitos.Columns.Add("VSahkoposti");
            oppilaitos.Columns.Add("VPuhelin");
        ...
        private void HenkilöCB_TextChanged(object sender, EventArgs e)
        {
            TitteliLB.Text = yhteys.Rows[HenkilöCB.SelectedIndex]["VTitteli"].ToString();
            OsastoLB.Text = yhteys.Rows[HenkilöCB.SelectedIndex]["VOsasto"].ToString();
            SähköpostiLB.Text = yhteys.Rows[HenkilöCB.SelectedIndex]["VSahkoposti"].ToString();
            PuhLB.Text = yhteys.Rows[HenkilöCB.SelectedIndex]["VPuhelin"].ToString();
        }
    }
}
